...
function EventSlideShowCard({ event }) {
  ...
  const eventContainerClass = "max-w-screen-md w-full h-full flex justify-center mx-auto flex-col place-content-center border-2 mb-2 rounded-lg overflow-hidden z-50 p-6 bg-blue-200 border-blue-800 rounded-lg shadow dark:bg-blue-800 dark:border-yellow-700  transition-colors duration-300 ease-in-out hover:bg-blue-300";
