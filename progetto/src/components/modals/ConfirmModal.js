    ...
    return(
        <div id="popup-modal" className={modalContainerClass} >
            <div className={modalDivClass}>
                <button onClick={onDelete} type="button" className={closeButtonClass} data-modal-hide="popup-modal">
                ...
                <div className={textContainerClass}>
                    ...
                    <button onClick={onDelete} data-modal-hide="popup-modal" type="button" className={cancelButtonClass}>No, cancel</button>
                </div>
            </div>
        </div>
    )
