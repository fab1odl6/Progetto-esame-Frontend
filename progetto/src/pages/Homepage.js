...
function HomePage() {
  ...
  const welcometextClass = "absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-4xl font-bold shadow-lg";
  ...
  return (
    <div className={bgcolor}>
      <div className="custom-image-container" style={{ position: "relative" }}>
        ...
        <div className={welcometextClass} style={{ textShadow: '-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000' }}> WELCOME TO ART TREASURES </div>
      </div>
      ...
      <div className={positionitemClass}>
        ...
        <div className={boxstyleClass}>
          <svg className={textboxClass} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 14">
